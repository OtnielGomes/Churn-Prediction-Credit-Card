...
def optimize_dtypes(
    ...
    # Interger Columns
    integer_cols =  ['Customer_Age', 'Dependent_count', 'Months_on_book', 'Total_Relationship_Count', 'Months_Inactive_12_mon',
...
# Initialize Class
    ...
    def mannwhitney_u_test(
        ...
        - ❌ Low significance (P >= 0.05): Probably noise, without statistical separation power.
    ...
    def chi_square_test(
        ...
        - ❌ Low significance: P-value >= 0.05 (Variables Independent/Noise).
